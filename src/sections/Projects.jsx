            ...
            <div className="work-card-left">
              ...
              <div className="project-action-row">
                {project.link ? (
                  ...
                  >
                    <span className="link-text">Visit Live Project</span>
                    <span className="link-arrow-circle">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="link-arrow-icon">
                  ...
                  <div className="project-action-placeholder" aria-hidden="true"></div>
                )}
              </div>
            </div>
